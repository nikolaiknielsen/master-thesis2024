...
from mflow.models.model import BaseModel
import pandas as pd
import torch
import torch.nn as nn
import torch.nn.functional as F
import torchvision as tv
import mflow.models.dataset as dt
...
class SpecVEA(BaseVAE):
    def __init__(self, device=None):
        config = {
            ...
            'layer_config': [[200, 128, 64, 6346], [6346, 64, 128, 200]], 
            'transform': None,
            'beta': 1.0, 
        }
        ...
        self.layer_config = self.get_attribute('layer_config', required=False, default = [[200, 128, 64, 32], [32, 64, 128, 200]] )
        self.build_layers()
        if self.device:
            self.to(self.device)
